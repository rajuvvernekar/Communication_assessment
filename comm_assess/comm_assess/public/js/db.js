...
YOUR TASK: Identify minimum 8 coaching opportunities.', checklist: [] },
  ...
  } = await _sb.from('topics').select('*', { count: 'exact', head: true }).like('module', 'mgr-%');
