...
const DB = (() => {
  ...
  async function _seedManagerTopics() {
    try {
      ...
      const MGR_TA_CONTENT_VERSION = 4; // v4 (2026-09-20): full replace with the exact 4 cases from the manager training doc (The Panicked SIP Investor, The Wrong Brokerage Charged, The Bonus Share Discrepancy, The Unauthorised Transaction Allegation) — the doc's own numbering skips "Case 4", so only 4 real cases exist
